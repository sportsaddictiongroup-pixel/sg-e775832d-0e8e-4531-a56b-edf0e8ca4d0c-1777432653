    ...
    return (
      <Card className={`shrink-0 min-w-[140px] max-w-[180px] w-[140px] sm:w-[160px] h-[110px] sm:h-[124px] shadow-sm hover:shadow-md z-10 relative overflow-hidden rounded-2xl border-2 ${theme.card} transition-all duration-200 hover:-translate-y-0.5`}>
        ...
        <CardContent className="p-2 sm:p-3 flex flex-col items-center text-center h-full mt-0.5 sm:mt-1">
          ...
          <h4 className={`text-[10px] sm:text-xs font-extrabold truncate w-full px-1 ${theme.title}`} title={partner.partner_name}>
            {partner.partner_name}
          </h4>
          <p className="text-[8px] sm:text-[9px] text-muted-foreground font-mono mt-0.5 px-1.5 py-0.5 rounded bg-background/80 shadow-sm border border-muted-foreground/10 truncate max-w-[95%]" title={partner.user_id}>
            {partner.user_id}
          </p>
            ...
            <div className="min-w-max flex flex-row flex-nowrap gap-4 items-start pt-6 sm:pt-8 border-t-2 border-border dark:border-border relative px-4 justify-center">
              {children.map((child) => (
                <div key={child.profile_id} className="flex flex-col items-center relative shrink-0">
                  ...
                  <div className="w-0.5 h-6 sm:h-8 bg-border dark:bg-border absolute -top-6 sm:-top-8 left-1/2 -translate-x-1/2" />
                      ...
                      <div className="flex flex-col items-center w-full">
                        ...
                        {selectedChildren.length > 30 && (
                          <div className="py-6 flex flex-col items-center border-t border-border/50 w-full bg-muted/10">
                             <div className="h-10 w-10 rounded-xl bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center mb-3 shadow-sm border border-amber-200 dark:border-amber-800">
